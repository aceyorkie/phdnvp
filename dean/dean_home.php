...
<head>
    ...
    <link rel="stylesheet" href="dean_home.css">
</head>
<body>
    <nav>
        <div class="nav-left">
        ...
        <div class="nav-center">
            ...
            <a href="/PH_DN_VP_Dashboard/dean/dean_notification.php">Notifications</a>
    ...
    <script>
        function home() {
            window.location.href = 'dean_home.php'; 
        }
        function requests(){
            window.location.href = '/PH_DN_VP_Dashboard/dean/request.php';
        }
    </script>
