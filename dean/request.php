...
$latestRequestSql = "SELECT request_id FROM signature_flow WHERE role = 'Dean' AND signatory_id = '$id_no' ORDER BY id DESC LIMIT 1";
...
<html>
<head>
    <title>Dean Signatory Dashboard</title>
...
<body>
  ...
  <script>
    ...
    // Global to track current open PDF
