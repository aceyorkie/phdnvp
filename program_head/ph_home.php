...
$sql = "SELECT id_no, name, department, profile_image FROM programhead WHERE id_no='$id_no'";
...
<head>
    ...
    <link rel="stylesheet" href="ph_home.css">
</head>
<body>
    <nav>
        <div class="nav-left">
        ...
        <div class="nav-center">
            ...
            <a href="/PH_DN_VP_Dashboard/program_head/ph_notification.php">Notifications</a>
    ...
    <div class="main-profile-section">
            ...
            <?php
                if ($result->num_rows == 1) {
                    ...
                    $profileImage = !empty($row['profile_image']) 
                        ...
                        : '/officerDashboardCopy/uploads/default.jpg';
                    ...
                    echo "
                        <div class='grid-container2'>
                            ...
                            <div class='profile-name'>
                                <h3 style='font-weight: 800'>$id_no</h3>
                                <h1>$name</h1>
                                <h3>Program Head</h3>
                                <h3>$department</h3>
                            </div>
        ...
        <a href="department1.php" class="extra-box">
            <img class="dept_img" src="/osaDashboard/dept-img/DTP_Logo.jpg">
            <span class="extra-box-text">Department of </br> Technical Programs</span>
        </a>
    </div>
    ...
    <script>
        ...
        function requests(){
            window.location.href = '/PH_DN_VP_Dashboard/program_head/request.php';
        }
    </script>
